...
class CurveNet(nn.Module):
    def __init__(self, num_classes=50, category=16, k=32, setting='default'):
        ...
        #self.lpfa = LPFA(24, additional_channel, k=k, mlp_num=1, initial=True)
        ...
        self.cic51 = CIC(npoint=62, radius=2.0, k=7, in_channels=512, output_channels=1024, bottleneck_ratio=2, curve_config=curve_config[setting][4])
        self.cic52 = CIC(npoint=62, radius=2.0, k=7, in_channels=1024, output_channels=1024, bottleneck_ratio=4, curve_config=curve_config[setting][4])
        self.cic53 = CIC(npoint=62, radius=2.0, k=7, in_channels=1024, output_channels=1024, bottleneck_ratio=4, curve_config=curve_config[setting][4])
        ...
        self.fp4 = PointNetFeaturePropagation(in_channel=1024 + 512, mlp=[512, 512], att=[1024, 512, 256])
        self.up_cic5 = CIC(npoint=250, radius=1.2, k=31, in_channels=512, output_channels=512, bottleneck_ratio=4)
        ...
        #self.up_cic2 = CIC(npoint=2048, radius=0.2, k=k, in_channels=128+64+64+3, output_channels=256, bottleneck_ratio=4)
