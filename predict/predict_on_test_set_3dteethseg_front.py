...
#file_path= '../data/file_lists_16k_8_class_shuffled_cropped_3dteethseg_half_jaw/'
file_path= '../data/file_lists_16k_8_class_shuffled_cropped_3dteethseg_front/'
...
#data_path='../pred_58/data/tooth_data_folds_revised_16k_8_class_shuffled_cntrd_bbx_cropped_3dteethseg_half_jaw/'
data_path='../pred_58/data/tooth_data_folds_revised_16k_8_class_shuffled_cntrd_bbx_cropped_3dteethseg_front/'
...
#test_src= '../data/3dteethseg_all_vtps_combined_flipped_16k_8class_meshes_cropped_half_jaw/'
test_src= '../data/3dteethseg_all_vtps_combined_flipped_16k_8class_meshes_cropped_front/'
...
output_path = './outputs_single_tooth_front'
