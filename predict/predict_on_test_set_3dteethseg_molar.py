...
#parser.add_argument("network"o, default='dgcnn' ,help="predict the segmentation")
parser.add_argument('--network', type=str, default='dgcnn', help='segmentation prediction network')
...
#file_path = '../data/file_lists_16k_8_class_shuffled_no_aug_single_tooth_half_jaw/'
#file_path = '../data/file_lists_16k_8_class_shuffled_no_aug_single_tooth_molar/'
file_path= '../data/file_lists_16k_8_class_shuffled_cropped_3dteethseg_molar/'
...
#data_path='../pred_58/data/tooth_data_folds_revised_16k_8_class_shuffled_cntrd_bbx_no_aug_single_tooth_half_jaw/'
#data_path='../pred_58/data/tooth_data_folds_revised_16k_8_class_shuffled_cntrd_bbx_no_aug_single_tooth_molar/'
data_path='../pred_58/data/tooth_data_folds_revised_16k_8_class_shuffled_cntrd_bbx_cropped_3dteethseg_molar/'
...
#test_src='../data/all_vtps_combined_flipped_16k_8_class_half_jaw/' # although the folder contains flipped data
#test_src='../data/all_vtps_combined_flipped_16k_8_class_molar/' # although the folder contains flipped data
test_src= '../data/3dteethseg_all_vtps_combined_flipped_16k_8class_meshes_cropped_molar/'


#mesh_path = './'  # need to define
#sample_filenames = ['Example.stl'] # need to define
#output_path = './outputs'
#output_path = './outputs_single_tooth_half_jaw'
output_path = './outputs_single_tooth_molar'
    ...
    for fold in range(3, 4):    
        ...
        for phase_str in ['test']:
            ...
            for idx in range(len(data_list)):
                ...
                print('type of idx_mesh num', type(idx_mesh))
                idx_mesh_num = int(idx_mesh)
                #if network == 'mmnet' and idx_mesh_num == 200: # there are not enough cell counts for the downsampling via mmnet
                if network == 'mmnet' and ( '200' in idx_mesh or '321' in idx_mesh): # there are not enough cell counts for the downsampling via mmnet
                    print('found idx_mesh 200 and hence skipping it')
                    continue
        ...
        num_epochs = 1
        i_batch = 0
        if network == 'mmnet': # there are not enough cell counts for the downsampling via mmnet
            num_keys = num_keys - 2 # 2 problematic samples so far
